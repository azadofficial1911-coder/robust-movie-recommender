"""Detection metrics: TP, FP, TN, FN, Precision, Recall, F1, FPR."""
def confusion_counts(true_labels,predicted_labels,positive_label="suspicious"):
    ...
    for a,p in zip(true_labels,predicted_labels):
        ap=a==positive_label; pp=p==positive_label
        if ap and pp: tp+=1
...
def detection_metrics(true_labels,predicted_labels,positive_label="suspicious"):
